    ...
    <div class="grid overflow-hidden w-full rounded-lg border border-border-strong/60">
        <div class="flex flex-col md:flex-row items-center justify-between p-4">
            <div class="flex items-center gap-3">
                <div class="size-10 rounded-ui d-flex-place-center ui-subtle ui-subtle-gray">
            ...
            <x-ui.input.group class="flex-1 md:max-w-60">
                ...
                <x-ui.input.trailing absolute class="[--right-space:4px]">
                    <x-ui.button variant="ghost" intent="gray" size="sm" :icon-only="true">
        ...
        <x-ui.table wrapper="border-t border-border-strong/60">
            <x-ui.table.columns headerBgStyle="gray">
                <x-ui.table.column class="w-5" whiteSpace="normal">
                    <x-ui.checkbox name="select_all" id="select_all_02" />
                </x-ui.table.column>
            ...
            <x-ui.pagination justify="end" class="flex-1">
                <x-ui.pagination.content>
                    <x-ui.pagination.item>
                        <x-ui.pagination.link href="#" aria-label="Prev page">
