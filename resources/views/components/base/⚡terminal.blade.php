...
<div data-code-block
    ...
    <x-docs.block-code title="Shell" icon="shell" shell-style="true">
        <x-docs.code-view-box is-shell :no-copy-button="true" class="bg-(--astro-code-color-background) inner-radius">
            <livewire:base.render-block-code defer :code="$code" lang="shell" />
