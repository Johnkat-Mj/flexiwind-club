<x-layouts.doc-page-wrapper :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug">
    ...
    <x-docs.table>
        ...
        <x-ui.table.row>
            ...
            <x-ui.table.cell><x-docs.table-description>Body wrapper with <x-docs.inline-code no-wrap text="striped" /> and divider behavior.</x-docs.table-description></x-ui.table.cell>
        </x-ui.table.row>
        <x-ui.table.row>
            <x-ui.table.cell><x-docs.inline-code no-wrap text="x-ui.table.row" /></x-ui.table.cell>
            <x-ui.table.cell><x-docs.table-description>Single row supporting <x-docs.inline-code no-wrap text="hoverable" />, <x-docs.inline-code no-wrap text="striped" />, and <x-docs.inline-code no-wrap text="noDivider" />.</x-docs.table-description></x-ui.table.cell>
        </x-ui.table.row>
        <x-ui.table.row>
