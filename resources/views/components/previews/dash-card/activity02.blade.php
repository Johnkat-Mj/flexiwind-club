        ...
        <div class="space-y-3">
            <x-ui.card size="none" class="flex flex-col space-y-1 p-3 rounded-ui">
                <div class="flex items-center justify-between space-x-3">
                    <span class="font-medium text-foreground flex-1">User Registration</span>
            ...
            <x-ui.card size="none" class="flex flex-col space-y-1 p-3 rounded-ui">
                <div class="flex items-center justify-between space-x-3">
                    <span class="font-medium text-foreground flex-1">Payment Processed</span>
                    <x-ui.badge size="sm" variant="soft" intent="success">
                        Success
                    </x-ui.badge>
                </div>
            ...
            <x-ui.card size="none" class="flex flex-col space-y-1 p-3 rounded-ui">
                <div class="flex items-center justify-between space-x-3">
                    <span class="font-medium text-foreground flex-1">Login Attempt</span>
