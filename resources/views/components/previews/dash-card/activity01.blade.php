<x-ui.card size="none" class="max-w-sm mx-auto rounded-ui">
    <div class="flex items-center justify-between p-4 pb-4">
        <h4 class="text-lg font-semibold text-title-foreground ">Recent Activity</h4>
        <x-ui.button size="sm" icon-only variant="ghost">
            <span aria-hidden="true" class="iconify ph--dots-three-vertical"></span>
        </x-ui.button>
    </div>
    <div class="px-4 pb-4 space-y-4">
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-subtle/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    ...
                    <p class="text-sm">
                        <span class="font-medium text-foreground">Sarah Chen</span>
                        <span class="text-muted-foreground ml-1">commented on your post</span>
                    </p>
                </div>
                <p class="text-sm text-muted-foreground bg-subtle p-2 rounded border-l-2 border-primary">
        ...
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-subtle/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    ...
                    <p class="text-sm">
                        <span class="font-medium text-foreground">Mike Johnson</span>
                        <span class="text-muted-foreground ml-1">liked your article</span>
                    </p>
                </div>
                <p class="text-sm text-muted-foreground bg-subtle p-2 rounded border-l-2 border-primary">
        ...
        <div class="flex items-start space-x-3 p-3 rounded-lg hover:bg-subtle/50 transition-colors">
            ...
            <div class="flex-1 space-y-1">
                <div class="flex items-center space-x-2">
                    ...
                    <p class="text-sm">
                        <span class="font-medium text-foreground">Emma Wilson</span>
                        <span class="text-muted-foreground ml-1">shared your post</span>
                    </p>
                </div>
                <p class="text-sm text-muted-foreground bg-subtle p-2 rounded border-l-2 border-primary">
