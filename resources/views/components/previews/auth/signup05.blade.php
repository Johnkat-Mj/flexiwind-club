<main class="flex min-h-screen h-max justify-center items-center px-4 sm:px-10 lg:px-0 py-8">
    <form class="bg-background border border-border shadow rounded-ui p-6 sm:p-8 flex flex-col w-full max-w-lg">
