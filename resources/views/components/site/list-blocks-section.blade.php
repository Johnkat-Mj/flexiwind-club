            ...
            <x-ui.tabs.list-wrapper
                ...
                <x-ui.tabs.list unStyled
                    ...
                    <x-ui.tabs.trigger unStyled id="tab-app-blocks" wrapper-class="flex h-full"
                        class="text-sm text-muted-foreground fx-active:text-title-foreground  px-3 h-full flex items-center fx-active:bg-background fx-active:ring-border/50 ring-1 ring-transparent inner-radius">
                        <span>
