    ...
    <nav class="bg-background border border-border rounded-lg p-4 h-16 flex items-center">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center space-x-4">
                ...
                <h1 class="font-semibold text-title-foreground  hidden truncate sm:inline-flex" data-testid="header-title">
                    Dashboard Overview
                </h1>
            </div>

            <div class="hidden md:flex items-center flex-1 max-w-sm mx-8">
