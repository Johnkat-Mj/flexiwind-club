<x-layouts.doc-page-wrapper :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug">
    ...
    <x-docs.table>
        ...
        <x-ui.table.row>
            ...
            <x-ui.table.cell><x-docs.table-description>Switches trigger strategy from click to
                    hover.</x-docs.table-description></x-ui.table.cell>
        </x-ui.table.row>
        <x-ui.table.row>
    ...
    <x-md.ul>
        <x-md.li>Use <x-docs.doc-link href="/components/tooltip">tooltip</x-docs.doc-link> for short non-interactive
            hints.</x-md.li>
        <x-md.li>Use <x-docs.doc-link href="/components/dropdown">dropdown</x-docs.doc-link> for concise action
            menus.</x-md.li>
        <x-md.li>Use <x-docs.doc-link href="/components/modal">modal</x-docs.doc-link> for complex or high-focus
            workflows.</x-md.li>
    </x-md.ul>
