<section class="border-t border-dashed border-border-strong/70 px-2 sm:px-4 xl:px-8">
    <div
        class="mx-auto w-full lg:max-w-336 xl:max-w-352 border-x border-border-strong/70 pt-20 border-dashed border-t relative">
        ...
        <div class="px-3.5 sm:px-8 md:px-16 lg:px-8 xl:px-0 mx-auto w-full max-w-3xl lg:max-w-5xl flex flex-col">
            <h2
                ...
                Build beautiful Laravel apps in minutes, not months.
            </h2>
            <p class="text-fg-muted max-w-md text-sm mt-6.5">
                Production-ready blocks built with Tailwind CSS v4. Copy, paste, and ship faster with complete control
                over your code.
            </p>
            <div class="flex flex-wrap gap-3 mt-9 ">
                ...
                <x-ui.button href="https://github.com/unoforge/flexiwind" variant="outline" size="sm"
                    class="sm:btn-md">
                    <span aria-hidden="true" class="iconify ph--github-logo-duotone opacity-80 mr-2 size-3.5"></span>
                    View on GitHub
                </x-ui.button>
            </div>
        </div>
