...
@php
    ...
    $variantClasses = match ($variant) {
        'default' => 'ui-form-base ui-form-input rounded-ui bg-background border border-border-input text-foreground',
        'ghost' => 'ui-form-base ui-form-input rounded-ui border border-border-input text-foreground',
