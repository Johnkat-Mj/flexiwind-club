...
<main class="">
    <section
        ...
        <div class="absolute inset-0 flex justify-center px-3.5">
            <div
                class="flex h-full relative bg-background border border-border dark:border-border-strong rounded-ui w-full max-w-340 pointer-events-none before:absolute before:-left-2.5 before:-right-2.5 before:-top-2.5 before:-bottom-2.5 before:border-x before:border-border dark:before:border-border-strong">
            </div>
        </div>
        ...
        <div class="absolute inset-0 px-3.5 flex justify-center items-end">
            <div aria-hidden="true"
                ...
                <span aria-hidden="true" class="flex bg-linear-to-t from-muted/60 h-2/5"></span>
                <span aria-hidden="true" class="flex bg-linear-to-t from-muted/60 h-3/5"></span>
                <span aria-hidden="true" class="hidden sm:flex bg-linear-to-t from-muted/60 h-4/5"></span>
                <span aria-hidden="true" class="hidden md:flex bg-linear-to-t from-muted/60"></span>
                <span aria-hidden="true" class="flex bg-linear-to-t from-muted/60"></span>
                <span aria-hidden="true" class="flex bg-linear-to-t from-muted/60"></span>
                <span aria-hidden="true" class="hidden md:flex bg-linear-to-t from-muted/60"></span>
                <span aria-hidden="true" class="flex bg-linear-to-t from-muted/60"></span>
                <span aria-hidden="true" class="hidden md:flex bg-linear-to-t from-muted/60"></span>
        ...
        <div class="relative py-20 md:py-28 max-w-6xl flex flex-col items-center text-center px-4">
            <a href=""
                class="ring ring-border-strong/80 bg-background text-foreground pl-(--annonce-padding) pr-2 py-(--annonce-padding) rounded-(--annonce-radius) [--annonce-padding:--spacing(0.5)] [--annonce-radius:var(--radius-ui)] text-sm flex items-center gap-1">
                <span
                    class="bg-muted text-title-foreground  rounded-[calc(var(--annonce-radius)-var(--annonce-padding))] px-2 py-0.5">
                    Soon
                </span>
                <span>
            ...
            <p class="max-w-md pt-8 text-muted-foreground text-sm">
