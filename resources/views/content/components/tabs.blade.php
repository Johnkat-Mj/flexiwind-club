<x-layouts.doc-page-wrapper :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug">
    ...
    <x-docs.steps>
        <x-docs.step>
            ...
            <livewire:base.terminal code="php artisan flexi:add tabs" />
        </x-docs.step>
        <x-docs.step>
        ...
        <x-docs.step>
            ...
            <x-md.ol>
                ...
                <livewire:base.load-code :name="['add-tabs-plugin-in-app']" />
                ...
                <livewire:base.load-code :name="['add-tabs-in-app']" />
            </x-md.ol>
        </x-docs.step>
    </x-docs.steps>
    ...
    <livewire:base.component-tab-preview-code component="components.examples.tabs.form" />
    ...
    <x-md.h2>API</x-md.h2>
    <x-md.paragraph>
        API details are documented above in the <strong>References</strong> section (component props, subcomponents, and
        events).
    </x-md.paragraph>
