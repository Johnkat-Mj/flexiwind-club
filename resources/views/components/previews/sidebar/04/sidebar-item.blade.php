...
<li class="flex w-full">
    <a href="{{ $href }}" aria-label="Link to {{ $text }}" data-state="{{ $isActive ? 'active' : 'inactive' }}"
        ...
        relative hover:before:bg-muted/60 before:absolute before:rounded-ui before:inset-0 active:before:scale-y-[.95] active:before:scale-x-[.98] before:transition-transform before:transform before:ease-linear fx-active:before:bg-primary fx-current:before:bg-primary
        ">
