<main class="min-h-screen d-flex-place-center px-5 sm:px-10 lg:px-0 py-6">
    <form action=""
        class="border border-border-strong/40 w-full max-w-md p-1 shadow-md shadow-gray-200/40 dark:shadow-transparent bg-background rounded-ui">
        <div class="p-5 sm:p-8">
            ...
            <div class="text-center">
                <h1 class="text-title-foreground  mb-1 text-xl font-semibold">Welcome back</h1>
