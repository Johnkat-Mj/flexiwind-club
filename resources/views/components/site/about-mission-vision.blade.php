<section class="">
    <div class="mx-auto w-full lg:max-w-300 border-x border-border-strong/70 border-dashed">
        <x-atoms.site-section-header subtitle="Mission and vision"
            title="Built to make product delivery clearer, faster, and more reliable"
            description="We design and implement solid UI systems for teams that want speed without sacrificing quality or long-term maintainability.">
