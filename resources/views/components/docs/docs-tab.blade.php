                ...
                @if (is_string($value))
                    <li role="presentation" class="flex">
                        <a data-tabs-trigger data-target="{{ $value }}" href="#{{ $value }}" role="tab"
                            ...
                            class="relative text-nowrap flex disabled:cursor-not-allowed disabled:opacity-80 fx-active:text-title-foreground  outline-none focus:outline-0 focus:outline-transparent focus-visible:outline focus-visible:outline-primary {{ $triggersClass !== '' ? $triggersClass : 'px-4 pt-1.5 pb-2.5' }}">
                            {{ $value }}
                        </a>
                    </li>
                @elseif(is_array($value))
                    <li role="presentation" class="flex">
                        <a data-tabs-trigger data-target="{{ $value['value'] ?? '' }}"
                            ...
                            class="relative flex items-center disabled:cursor-not-allowed disabled:opacity-80 fx-active:text-title-foreground  outline-none focus:outline-0 focus:outline-transparent focus-visible:outline focus-visible:outline-primary {{ $triggersClass !== '' ? $triggersClass : 'px-4 pt-1.5 pb-2.5' }}">
