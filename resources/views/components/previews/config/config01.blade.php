<div class="max-w-3xl w-full p-4 mx-auto">
    <div class="bg-bg rounded-lg shadow border border-border-strong/70 p-5 sm:p-8 lg:p-10">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-fg-title">Account Settings</h2>
        ...
        <form class="space-y-8">
            <div class="space-y-4">
                <h3 class="font-medium text-fg-title border-b border-border pb-2">
                    Profile Information
                </h3>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <x-ui.switch outlined size="sm" id="email_notif" name="email_notif"
                            class="text-primary [--knob-bg:var(--color-white)] bg-bg-muted/60" />
                    </div>
                    <div class="flex items-center justify-between">
                        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4">
                    <div class="flex flex-col space-y-2">
                        <label class="text-sm text-fg">Profile Visibility</label>
