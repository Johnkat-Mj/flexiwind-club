<header class="sticky top-0 w-full bg-bg/70 backdrop-blur-sm border-b border-border">
...
<main class="mx-auto max-w-6xl px-5 pb-6 pt-10">
    ...
    <div class="grid sm:grid-cols-2 gap-4 mb-8">
        <div class="rounded-ui h-76 border border-border-strong/70">
